...
main (int argc, char *argv[])
{
  ...
  if(nullmsg){
    ...
    Ptr<Node> n3 = CreateObject<Node> (3);
    Ptr<Node> n4 = CreateObject<Node> (4);
    leftLeafNodes.Add(n1);
    leftLeafNodes.Add(n2);
    leftLeafNodes.Add(n3);
    leftLeafNodes.Add(n4);
  }
  ...
  NodeContainer rightLeafNodes;
   if(nullmsg){
    ...
    Ptr<Node> n3 = CreateObject<Node> (3);
    Ptr<Node> n4 = CreateObject<Node> (4);
    rightLeafNodes.Add (n1);
    rightLeafNodes.Add (n2);
    rightLeafNodes.Add (n3);
    rightLeafNodes.Add (n4);
  }
